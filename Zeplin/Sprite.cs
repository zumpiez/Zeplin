...
namespace Zeplin
{
    ...
    public class Sprite
    {
        ...
        internal void Draw(Transformation transformation, float depth)
        {
            Draw(transformation, depth, null);
        }
        ...
        /// <remarks>If on a layer, depth only applies within that layer.</remarks>
        internal void Draw(Transformation transformation, float depth, Rectangle? sourceRectangle)
        {
            Engine.spriteBatch.Draw(image, new Vector2(transformation.Position.X, -transformation.Position.Y), sourceRectangle, color, transformation.Rotation, transformation.Pivot, transformation.Scale, Facing, depth);
        }
